...
Runs linting against documentation using [silverstripe/documentation-lint](https://github.com/silverstripe/documentation-lint/) if the `.ss-docs-lint` config file is available. Default is true, disable with:
`doclinting: false`
